...
## 7) KPI Measurement Priorities (Founder-Confirmed)

Program-level priorities:
- stability improvement across housing, transportation, and finances
- conversion to resource access
- utilization by support area (including participants per area)
- partner service standard compliance
- program awareness via periodic internal survey

Coordinator-level priorities:
- referral response rate
- employee engagements
- resource presentations
- time allocation
- employee feedback/satisfaction
- documentation completion/submission rates
